...
static const struct GraphemeBreakProperties gb_prop_default[] = {
	...
	{0x0CBF, 0x0CC0, GBP_Extend},
	{0x0CC1, 0x0CC1, GBP_SpacingMark},
	{0x0CC2, 0x0CC2, GBP_Extend},
	{0x0CC3, 0x0CC4, GBP_SpacingMark},
	{0x0CC6, 0x0CC8, GBP_Extend},
	{0x0CCA, 0x0CCD, GBP_Extend},
	...
	{0x1AB0, 0x1ADD, GBP_Extend},
	{0x1AE0, 0x1AEB, GBP_Extend},
	{0x1B00, 0x1B03, GBP_Extend},
	{0x1B04, 0x1B04, GBP_SpacingMark},
	{0x1B34, 0x1B3D, GBP_Extend},
	{0x1B3E, 0x1B41, GBP_SpacingMark},
	{0x1B42, 0x1B44, GBP_Extend},
	...
	{0xA952, 0xA952, GBP_SpacingMark},
	{0xA953, 0xA953, GBP_Extend},
	{0xA960, 0xA97C, GBP_L},
	...
	{0xA9BE, 0xA9BF, GBP_SpacingMark},
	{0xA9C0, 0xA9C0, GBP_Extend},
	...
	{0x10D69, 0x10D6D, GBP_Extend},
	{0x10EAB, 0x10EAC, GBP_Extend},
	{0x10EFA, 0x10EFF, GBP_Extend},
	...
	{0x111BF, 0x111BF, GBP_SpacingMark},
	{0x111C0, 0x111C0, GBP_Extend},
	...
	{0x1134B, 0x1134C, GBP_SpacingMark},
	{0x1134D, 0x1134D, GBP_Extend},
	{0x11357, 0x11357, GBP_Extend},
	{0x11362, 0x11363, GBP_SpacingMark},
	{0x11366, 0x1136C, GBP_Extend},
	{0x11370, 0x11374, GBP_Extend},
	{0x113B8, 0x113B8, GBP_Extend},
	{0x113B9, 0x113BA, GBP_SpacingMark},
	{0x113BB, 0x113C0, GBP_Extend},
	{0x113C2, 0x113C2, GBP_Extend},
	{0x113C5, 0x113C5, GBP_Extend},
	{0x113C7, 0x113C9, GBP_Extend},
	{0x113CA, 0x113CA, GBP_SpacingMark},
	{0x113CC, 0x113CD, GBP_SpacingMark},
	{0x113CE, 0x113D0, GBP_Extend},
	{0x113D1, 0x113D1, GBP_Prepend},
	{0x113D2, 0x113D2, GBP_Extend},
	{0x113E1, 0x113E2, GBP_Extend},
	...
	{0x116B0, 0x116B7, GBP_Extend},
	{0x1171D, 0x1171D, GBP_Extend},
	{0x1171E, 0x1171E, GBP_SpacingMark},
	{0x1171F, 0x1171F, GBP_Extend},
	...
	{0x11B60, 0x11B60, GBP_Extend},
	{0x11B61, 0x11B61, GBP_SpacingMark},
	{0x11B62, 0x11B64, GBP_Extend},
	{0x11B65, 0x11B65, GBP_SpacingMark},
	{0x11B66, 0x11B66, GBP_Extend},
	{0x11B67, 0x11B67, GBP_SpacingMark},
	...
	{0x1E5EE, 0x1E5EF, GBP_Extend},
	{0x1E6E3, 0x1E6E3, GBP_Extend},
	{0x1E6E6, 0x1E6E6, GBP_Extend},
	{0x1E6EE, 0x1E6EF, GBP_Extend},
	{0x1E6F5, 0x1E6F5, GBP_Extend},
